...
const LevelSelector = ({ level, setLevel }) => {
  ...
  return (
    <div ref={containerRef} className="bg-white dark:bg-slate-900 p-5 rounded-2xl border border-slate-200 dark:border-slate-800 shadow-sm relative overflow-visible">
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="relative">
           ...
           {/* 메인 툴팁 - 클릭/터치 대응 */}
           <div className={`absolute bottom-full right-0 mb-3 w-56 p-3 bg-slate-900 dark:bg-slate-800 text-white text-[11px] rounded-xl transition-all z-[100] shadow-2xl border border-white/10 leading-relaxed pointer-events-none
