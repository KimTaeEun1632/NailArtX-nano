      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full bg-primary/20 dark:bg-primary/40 rounded-full blur-[100px] opacity-0 group-hover/canvas:opacity-100 transition-opacity duration-1000" />
          </div>
              ...
              <div className="absolute bottom-6 right-6 z-30 flex gap-3 opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300">
                ...
                {navigator.share && (
                  ...
                  >
                    <svg
                      ...
                      strokeWidth={2}
                      stroke="currentColor"
                      className="w-5 h-5 text-slate-700 dark:text-slate-200 group-hover/btn:text-primary transition-colors"
                    >
                ...
                >
                  <svg
                    ...
                    strokeWidth={2}
                    stroke="currentColor"
                    className="w-6 h-6 text-slate-700 dark:text-slate-200 group-hover/btn:text-primary transition-colors"
                  >
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
